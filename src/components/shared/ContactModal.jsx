      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
        ...
        >
          ...
          <div className="p-10 text-center">
            ...
            <h3 className="text-2xl font-black uppercase tracking-tighter mb-2">Get Support</h3>
            <p className="text-slate-500 font-medium mb-8 uppercase text-[10px] tracking-widest">Connect with our specialized agents</p>
